...
import { generateQuizQuestions, generateAdaptiveQuestions, generateQuestionsFromPassage } from "../controllers/aiQuestionController.js";
...
router.post("/quizzes/gemini-autofill", protect, adminOnly, aiQuestionLimiter, generateQuestionsFromPassage);
