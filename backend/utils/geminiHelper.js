...
const MODEL_PRIORITY = [
    ...
    "gemini-1.5-pro",         // 1K RPM, 1M TPM, 10K RPD - Latest flash
...
export const generateFromGemini = async (prompt, options = {}) => {
    ...
    const {
        preferredModel = "gemini-2.5-flash-lite", // Default to premium model (will fallback if quota exceeded)
 ...
 */
export const generateFromGeminiWithModel = async (prompt, modelName = "gemini-2.5-flash-lite") => {
