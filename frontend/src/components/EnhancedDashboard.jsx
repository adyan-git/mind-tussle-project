  ...
  const handlePWAInstall = async () => {
    ...
    try {
      ...
      if (success) {
        ...
        `;
        notification.innerHTML = '🎉 MindTussle installation started!';
            ...
            >
              <div className="installed-content">
                ...
                <div className="installed-text">
                  <h4>App Installed</h4>
                  <p>MindTussle is running as an installed app! Enjoy the full experience.</p>
                </div>
              </div>
            </motion.div>
          )}
