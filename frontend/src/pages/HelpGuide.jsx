    ...
    const sections = [
        {
            ...
            content: {
                ...
                features: [
                    ...
                    '📝 Create and share your own quizzes (Admin Suite)',
                ...
                subsections: [
                    {
                        ...
                        limitations: [
                            ...
                            'No Admin Suite dashboard'
                        ]
                    },
                    {
                        id: 'premium-user',
                        title: '🚀 Admin Suite User',
                        features: [
                    ...
                    },
                    {
                        ...
                        title: '👑 Admin User',
                        features: [
                            'Everything from Admin Suite User',
                            'Manage all quizzes',
        ...
        {
            id: 'how-to-use',
            title: 'How to Use MindTussle',
            icon: '🎯',
            content: {
                description: 'Follow these simple steps to get the most out of MindTussle:',
                steps: [
                    {
                        step: 1,
                        title: 'Sign Up & Login',
        ...
        {
            id: 'creating-quizzes',
            title: 'Creating Your Own Quizzes (Admin Suite)',
            icon: '📝',
            content: {
                description: 'As an Admin Suite user, you can create your own quizzes to share with others or use for personal study:',
                steps: [
                    {
                        step: 1,
        ...
        },
        {
            ...
            icon: '✨',
            content: {
                description: 'Explore all the amazing features MindTussle has to offer:',
                features: [
                    {
                        name: '📊 Dashboard',
                    ...
                    {
                        name: '📱 Mobile App',
                        description: 'Access MindTussle on your phone with our responsive design and PWA features.'
                    }
                ]
            }
        },
        {
            ...
            icon: '💡',
            content: {
                description: 'Get the most out of MindTussle with these helpful tips:',
                tips: [
                    {
        ...
        },
        {
            ...
            icon: '🚀',
            content: {
                description: 'Discover the powerful advanced features that make MindTussle stand out from other learning platforms:',
                features: [
                    {
                        name: '🤖 AI Study Buddy',
        ...
        },
        {
            ...
            icon: '📱',
            content: {
                description: 'MindTussle works seamlessly across all devices with our Progressive Web App technology:',
                features: [
                    {
                        name: '📱 Install as App',
                        description: 'Add MindTussle to your home screen for a native app experience. Works on iOS, Android, and desktop.'
                    },
                    {
                        name: '🌐 Offline Mode',
        ...
        },
        {
            ...
            content: {
                ...
                problems: [
                    ...
                    {
                        problem: 'Admin Suite features not available',
                        solutions: [
                            'Verify your Admin Suite subscription status',
                    ...
                    },
                    {
                        ...
                        solutions: [
                            'Verify you have an Admin Suite subscription',
                            'Check if you\'re logged in as an Admin Suite user',
                            'Try refreshing the page',
                            'Clear browser cache',
    ...
    return (
        <div className="help-guide-container">
            ...
            <div className="help-guide-header">
                ...
                >
                    Everything you need to know about MindTussle in simple, easy-to-understand language
                </motion.p>
            </div>
